...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func loadMonth() {
        ...
        let components: NSDateComponents = calendar.components([.Year, .Month], fromDate: NSDate())
        ...
        if latestMonth == nil {
            ...
            newMonth.date = calendar.dateFromComponents(components)
            dao.save()
...
//        dao.save()
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "dk.sjt.Budgetto" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Budgetto", withExtension: "momd")!
